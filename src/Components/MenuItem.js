...
const MenuItem = (props) => {
    ...
    return (
        <div className="w-[45%] p-[1%] ml-[25%] mt-[3%] bg-gray-400">
            <div className="flex">
            <div className="">
            ...
            <button className="w-[40%] ml-[45%] mt-[5%] p-[4%] bg-white text-black rounded-lg"><span className=" hidden">+</span>ADD</button>
            </div>
            </div>
        </div>
    )
